                        ...
                        <li
                            ...
                            <ul class="nav nav-children" style="">
                                @if(in_array('sale-opportunity', $vc_module_levels))
                                    ...
                                    {{-- KISS CRM (crm-comercial-kiss) — children of Preventa --}}
                                    <li class="{{ ($firstLevel === 'crm' && request()->is('crm')) ? 'nav-active' : '' }}">
                                        <a class="nav-link" href="{{ route('tenant.crm.dashboard') }}">
                                            Dashboard CRM
                                        </a>
                                    </li>
                                    <li class="{{ ($firstLevel === 'crm' && request()->is('crm/leads*')) ? 'nav-active' : '' }}">
                                        <a class="nav-link" href="{{ route('tenant.crm.leads') }}">
                                            Leads
                                        </a>
                                    </li>
                                    <li class="{{ ($firstLevel === 'crm' && request()->is('crm/opportunities*')) ? 'nav-active' : '' }}">
                                        <a class="nav-link" href="{{ route('tenant.crm.opportunities') }}">
                                            Oportunidades
                                        </a>
                                    </li>
                                @endif
